...
SOURCES            = main.c myLib.c game.c game2.c startBG.c loseBG.c winBG.c pauseBG.c gameBG.c instructionsBG.c spritesheet.c room1.c collisionmap1.c collisionmap2.c collisionmap3.c basement.c sound.c thecarnival.c hit.c shoot.c sky.c hallway.c game3.c playerhit.c cheer.c
CCPATH             = /usr/bin
DKPATH             = /Users/hyunjoochoi/Desktop/cs2261/devkitARM\ 2/bin
VBASIM             = open /Users/hyunjoochoi/Desktop/cs2261/visualboyadvance-m.app
FIND               = find
COPY               = cp -r
